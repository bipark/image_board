...
<script>
  ...
  export default {
    components: {
      'NavFooter': () => import('~/components/navigator/footer'),
      'MenuNormal': () => import('~/components/navigator/menu-normal'),
      'MenuAdmin': () => import('~/components/navigator/menu-admin'),
      'MenuUser': () => import('~/components/navigator/menu-user'),
      'MenuNotice': () => import('~/components/navigator/menu-notice'),
    },
